...
import { View, Text, FlatList, StyleSheet, TouchableOpacity, TextInput, Image, ImageBackground, ScrollView } from 'react-native';
...
export default function CategoryScreen({ route }: any) {
  ...
  return (
    <ImageBackground  source={isWhiteMode ? null : require('../assets/images/bg1.jpg')}
    ...
    resizeMode="cover">
      <View style={styles.header}>
        <View style={styles.greetingContainer}>
          ...
          <Text style={[styles.subGreeting, isWhiteMode && styles.subGreetingDark]}>Discover products that suit your needs</Text>
        </View>
      </View>

      <View style={[styles.searchContainer, isWhiteMode && styles.searchContainerDark]}>
        <TextInput 
          placeholder="Search" 
      ...
      <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.categoryContainer}>
        ...
        >
          <Text style={[styles.categoryText, !selectedWeight && styles.selectedCategoryText]}>
            All
          </Text>
        </TouchableOpacity>
        {['500g', '1kg'].map((weight) => (
          <TouchableOpacity
            ...
            onPress={() => setSelectedWeight(weight === selectedWeight ? '' : weight)} 
          >
            <Text style={[styles.categoryText, selectedWeight === weight && styles.selectedCategoryText]}>
              {weight}
            </Text>
          </TouchableOpacity>
        ))}
